...
The `content` field is a JSON-RPC-like message that is [NIP-44](nostr:naddr1qvzqqqrcvypzq2eeknl7v2fnm7tsuxfkds3vrcyjl9fls070a465urcy6k3mgk0eqqrxu6ts956rgat9m6z) encrypted and has the following structure:
...
_remote-signer_ MAY publish its metadata by using [NIP-05](nostr:naddr1qvzqqqrcvypzq2eeknl7v2fnm7tsuxfkds3vrcyjl9fls070a465urcy6k3mgk0eqqrxu6ts95cr222kljk) and [NIP-89](nostr:naddr1qvzqqqrcvypzq2eeknl7v2fnm7tsuxfkds3vrcyjl9fls070a465urcy6k3mgk0eqqrxu6ts95urjfhh9xr). With NIP-05, a request to `<remote-signer>/.well-known/nostr.json?name=_` MAY return this:
```yaml
{
    "names":{
